# Развертывание Kubernete-кластера с подключением мониторинга и развертыванием на нем приложения с Jenkins
...
Устанавливается конкретная версия Ansible с помощью pip.
```
...
* Развертывание 4-х серверов в облаке: 1 Jenkins, 1 Master, 2 Worker. И подготовка окружения перез развертыванием Kubernetes-кластера.
```
